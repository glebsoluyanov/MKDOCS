...
| `D0:65 RequestBR_GamePoint` |
| `D0:66 RequestBR_ProductList` |
| `D0:67 RequestBR_ProductInfo` |
| `D0:68 RequestBR_BuyProduct` |
...
| `FE:A7 ExBR_GamePoint` |
| `FE:A8 ExBR_ProductList` |
| `FE:A9 ExBR_ProductInfo` |
| `FE:AA ExBR_BuyProduct` |
| `FE:AB ExBR_PremiumState` |
| `FE:AC ExBrExtraUserInfo` |
| `FE:AD ExBrBroadcastEventState` |
| `FE:AE ExBrBuffEventState` |
