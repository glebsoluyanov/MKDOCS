...
| `D0:7F RequestBR_GamePoint` |
| `D0:80 RequestBR_ProductList` |
| `D0:81 RequestBR_ProductInfo` |
| `D0:82 RequestBR_BuyProduct` |
| `D0:83 RequestBR_RecentProductList` |
| `D0:84 RequestBR_MiniGameLoadScores` |
| `D0:85 RequestBR_MiniGameInsertScore` |
| `D0:86 RequestBR_LectureMark` |
...
| `FE:BC ExBrLoadEventTopRankers` |
| `FE:BD ExChangeNpcState` |
| `FE:BE ExAskModifyPartyLooting` |
| `FE:BF ExSetPartyLooting` |
| `FE:C0 ExRotation` |
| `FE:C1 ExChangeClientEffectInfo` |
| `FE:C2 ExMembershipInfo` |
| `FE:C3 ExReplyHandOverPartyMaster` |
| `FE:C4 ExQuestNpcLogList` |
| `FE:C5 ExQuestItemList` |
| `FE:C6 ExGMViewQuestItemList` |
| `FE:C7 ExRestartResponse` |
| `FE:C8 ExVoteSystemInfo` |
| `FE:C9 ExBR_GamePoint` |
| `FE:CA ExBR_ProductList` |
| `FE:CB ExBR_ProductInfo` |
| `FE:CC ExBR_BuyProduct` |
| `FE:CD ExBR_PremiumState` |
| `FE:CE ExBrExtraUserInfo` |
| `FE:CF ExBrBroadcastEventState` |
| `FE:D0 ExBrBuffEventState` |
| `FE:D1 ExBR_RecentProductList` |
| `FE:D2 ExBR_MinigameLoadScores` |
| `FE:D3 ExBR_AgathionEnergyInfo` |
