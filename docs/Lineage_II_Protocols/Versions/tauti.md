...
| `FE:E2 ExNavitAdventPointInfo` |
| `FE:E3 ExNavitAdventEffect` |
| `FE:E4 ExNavitAdventTimeChange` |
| `FE:E5 ExAbnormalStatusUpdateFromTarget` |
| `FE:E6 ExStopScenePlayer` |
| `FE:E7 ExFlyMove` |
| `FE:E8 ExDynamicQuest` |
| `FE:E9 ExSubjobInfo` |
| `FE:EA ExChangeMPCost` |
| `FE:EB ExFriendDetailInfo` |
| `FE:EC ExBlockAddResult` |
| `FE:ED ExBlockRemoveResult` |
| `FE:EE ExBlockDetailInfo` |
| `FE:EF ExLoadInzonePartyHistory` |
| `FE:F0 ExFriendNotifyNameChange` |
| `FE:F1 ExShowCommission` |
| `FE:F2 ExResponseCommissionItemList` |
| `FE:F3 ExResponseCommissionInfo` |
| `FE:F4 ExResponseCommissionRegister` |
| `FE:F5 ExResponseCommissionDelete` |
| `FE:F6 ExResponseCommissionList` |
| `FE:F7 ExResponseCommissionBuyInfo` |
| `FE:F8 ExResponseCommissionBuyItem` |
| `FE:F9 ExAcquirableSkillListByClass` |
| `FE:FA ExMagicAttackInfo` |
| `FE:FB ExAcquireSkillInfo` |
| `FE:FC ExNewSkillToLearnByLevelUp` |
| `FE:FD ExCallToChangeClass` |
| `FE:FE ExChangeToAwakenedClass` |
| `FE:FF ExTacticalSign` |
| `FE:100 ExLoadStatWorldRank` |
| `FE:101 ExLoadStatUser` |
| `FE:102 ExLoadStatHotLink` |
| `FE:103 ExWaitWaitingSubStituteInfo` |
| `FE:104 ExRegistWaitingSubstituteOk` |
| `FE:105 ExRegistPartySubstitute` |
| `FE:106 ExDeletePartySubstitute` |
| `FE:107 ExTimeOverPartySubstitute` |
| `FE:108 ExGet24HzSessionID` |
| `FE:109 Ex2ndPasswordCheck` |
| `FE:10A Ex2ndPasswordVerify` |
| `FE:10B Ex2ndPasswordAck` |
| `FE:10C ExFlyMoveBroadcast` |
| `FE:10D ExShowUsm` |
| `FE:10E ExShowStatPage` |
| `FE:10F ExIsCharNameCreatable` |
| `FE:110 ExGoodsInventoryChangedNotify` |
| `FE:111 ExGoodsInventoryInfo` |
| `FE:112 ExGoodsInventoryResult` |
| `FE:113 ExAlterSkillRequest` |
| `FE:114 ExNotifyFlyMoveStart` |
| `FE:115 ExDummy` |
| `FE:116 ExCloseCommission` |
| `FE:117 ExChangeAttributeItemList` |
| `FE:118 ExChangeAttributeInfo` |
| `FE:119 ExChangeAttributeOk` |
| `FE:11A ExChangeAttributeFail` |
| `FE:11B ExExchangeSubstitute` |
| `FE:11C ExLightingCandleEvent` |
| `FE:11D ExVitalityEffectInfo` |
| `FE:11E ExLoginVitalityEffectInfo` |
| `FE:11F ExBR_PresentBuyProduct` |
| `FE:120 ExMentorList` |
| `FE:121 ExMentorAdd` |
| `FE:122 ExMenteeListWaiting` |
| `FE:123 ExInzoneWaitingInfo` |
| `FE:124 ExCuriousHouseState` |
| `FE:125 ExCuriousHouseEnter` |
| `FE:126 ExCuriousHouseLeave` |
| `FE:127 ExCuriousHouseMemberList` |
| `FE:128 ExCuriousHouseMemberUpdate` |
| `FE:129 ExCuriousHouseRemainTime` |
| `FE:12A ExCuriousHouseResult` |
| `FE:12B ExCuriousHouseObserveList` |
| `FE:12C ExCuriousHouseObserveMode` |
| `FE:12E ExChoose_Shape_Shifting_Item` |
| `FE:12F ExPut_Shape_Shifting_Target_Item_Result` |
| `FE:130 ExPut_Shape_Shifting_Extraction_Item_Result` |
| `FE:131 ExShape_Shifting_Result` |
| `FE:132 ExCastleState` |
| `FE:133 ExNCGuardReceiveDataFromServer` |
| `FE:134 ExCheck_SpeedHack` |
