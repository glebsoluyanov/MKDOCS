...
| `D0:78 RequestBR_GamePoint` |
| `D0:79 RequestBR_ProductList` |
| `D0:7A RequestBR_ProductInfo` |
| `D0:7B RequestBR_BuyProduct` |
| `D0:7C RequestBR_RecentProductList` |
| `D0:7D RequestExBR_EventRankerList` |
| `D0:7E RequestBR_MiniGameLoadScores` |
| `D0:7F RequestBR_MiniGameInsertScore` |
| `D0:80 RequestBR_LectureMark` |
...
| `FE:B5 ExRaidCharSelected` |
| `FE:B6 ExRaidReserveResult` |
| `FE:B7 ExBuySellList` |
| `FE:B8 ExBR_GamePoint` |
| `FE:B9 ExBR_ProductList` |
| `FE:BA ExBR_ProductInfo` |
| `FE:BB ExBR_BuyProduct` |
| `FE:BC ExBR_PremiumState` |
| `FE:BD ExBrExtraUserInfo` |
| `FE:BE ExBrBroadcastEventState` |
| `FE:BF ExBrBuffEventState` |
| `FE:C0 ExBR_RecentProductList` |
| `FE:C1 ExBrLoadEventTopRankers` |
| `FE:C2 ExBR_MinigameLoadScores` |
| `FE:C3 ExBR_AgathionEnergyInfo` |
