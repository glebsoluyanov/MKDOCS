...
| `FE:13D ExCheck_SpeedHack` |
| `FE:13E ExBR_NewIConCashBtnWnd` |
| `FE:13F ExEventCampaignInfo` |
| `FE:140 ExValidateActiveCharacter` |
| `FE:141 ExCloseCommissionRegister` |
| `FE:142 ExTeleportToLocationActivate` |
| `FE:143 ExInvitation_Event_UI_Setting` |
| `FE:144 ExInvitation_Event_Ink_Energy` |
