...
| `D0:54:00 RequestBookMarkSlotInfo` |
| `D0:54:01 RequestSaveBookMarkSlot` |
| `D0:54:02 RequestModifyBookMarkSlot` |
| `D0:54:03 RequestDeleteBookMarkSlot` |
| `D0:54:04 RequestTeleportBookMark` |
| `D0:54:05 RequestChangeBookMarkSlot` |
| `D0:55 RequestWithDrawPremiumItem` |
| `D0:56 RequestStartShowCrataeCubeRank` |
| `D0:57 RequestStopShowCrataeCubeRank` |
| `D0:58 RequestNotifyStartMiniGame` |
...
| `FE:88 ExPVPMatchCCRecord` |
| `FE:89 ExPVPMatchCCMyRecord` |
| `FE:8A ExPVPMatchCCRetire` |
