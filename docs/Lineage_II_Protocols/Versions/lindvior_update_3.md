...
| `D0:F1 RequestLuckyGamePlay` |
| `D0:F2 RequestNotifyTrainingRoomEnd` |
| `D0:F3 RequestCardReward` |
...
| `FE:15B ExPathToAwakeningAlarm` |
| `FE:15C ExPartySmallWindowUpdateVital` |
| `FE:15D ExPartySmallWindowUpdateHPMPCP` |
| `FE:15E ExPartySmallWindowUpdateSubtitute` |
| `FE:15F ExGmViewCharacterInfo` |
| `FE:160 ExUserInfo` |
| `FE:161 ExUserInfoEquipSlot` |
| `FE:162 ExUserInfoCubic` |
| `FE:163 ExUserInfoAbnormalVisualEffect` |
| `FE:164 ExUserInfoFishing` |
| `FE:165 ExPetInfo` |
| `FE:166 ExSummonInfo` |
| `FE:167 ExNpcInfo` |
| `FE:168 ExStartLuckyGame` |
| `FE:169 ExBettingLuckyGameResult` |
| `FE:16A ExTrainingZone_Admission` |
| `FE:16B ExTrainingZone_Leaving` |
| `FE:16C ExPeriodicHenna` |
| `FE:16D ExNpcInfoState` |
| `FE:16E ExNpcInfoAbnormalVisualEffect` |
| `FE:16F ExUserInfoInvenWeight` |
| `FE:170 ExShowCardRewardList` |
