...
| `D0:CE RequestEventKalieToken` |
| `D0:CF RequestShowBeautyList` |
| `D0:D0 RequestRegistBeauty` |
| `D0:D2 RequestResetBeauty` |
| `D0:D3:01 SpeedHack` |
| `D0:D4 RequestBR_AddBasketProductInfo` |
| `D0:D5 RequestBR_DeleteBasketProductInfo` |
| `D0:D6 RequestBR_NewIConCashBtnWnd` |
| `D0:D8 RequestPledgeRecruitInfo` |
| `D0:D9 RequestPledgeRecruitBoardSearch` |
| `D0:DA RequestPledgeRecruitBoardAccess` |
| `D0:DB RequestPledgeRecruitBoardDetail` |
| `D0:DC RequestPledgeWaitingApply` |
| `D0:DD RequestPledgeWaitingApplied` |
| `D0:DE RequestPledgeWaitingList` |
| `D0:DF RequestPledgeWaitingUser` |
| `D0:E0 RequestPledgeWaitingUserAccept` |
| `D0:E1 RequestPledgeDraftListSearch` |
| `D0:E2 RequestPledgeDraftListApply` |
| `D0:E3 RequestPledgeRecruitApplyInfo` |
| `D0:E4 RequestPledgeJoinSys` |
| `D0:E5 RequestResponsePetitionAlarm` |
| `D0:E6 RequestNotifyExitBeautyshop` |
| `D0:E7 RequestRegisterXMasWishCard` |
| `D0:E8 RequestExAddEnchantScrollItem` |
| `D0:E9 RequestExRemoveEnchantSupportItem` |
| `D0:EA RequestCardReward` |
| `D0:EB RequestDivideAdenaStart` |
| `D0:EC RequestDivideAdenaCancel` |
| `D0:ED RequestDivideAdena` |
| `D0:EE RequestAcquireAbilityList` |
| `D0:EF RequestAbilityList` |
| `D0:F0 RequestResetAbilityPoint` |
| `D0:F1 RequestChangeAbilityPoint` |
| `D0:F2 RequestAbilityWndOpen` |
| `D0:F3 RequestAbilityWndClose` |
| `D0:F4 RequestExPCCafeRequestOpenWindowWithoutNPC` |
| `D0:F6 RequestLuckyGamePlay` |
| `D0:F7 RequestNotifyTrainingRoomEnd` |
| `D0:F8 RequestNewEnchantPushOne` |
| `D0:F9 RequestNewEnchantRemoveOne` |
| `D0:FA RequestNewEnchantPushTwo` |
| `D0:FB RequestNewEnchantRemoveTwo` |
| `D0:FC RequestNewEnchantClose` |
| `D0:FD RequestNewEnchantTry` |
| `D0:FE RequestExCardRewardList` |
| `D0:FF RequestExAccountAttendanceInfo` |
| `D0:100 RequestExAccountAttendanceReward` |
...
| `FE:135 ExKalieEvent` |
| `FE:136 ExKalieEventJackpotUser` |
| `FE:137 ExAbnormalVisualEffectInfo` |
| `FE:138 ExNpcInfoSpeed` |
| `FE:139 ExSetPledgeEmblemAck` |
| `FE:13A ExShowBeautyMenu` |
| `FE:13B ExResponseBeautyList` |
| `FE:13C ExResponseBeautyRegistReset` |
| `FE:13D ExResponseResetList` |
| `FE:13E ExShuffleSeedAndPublicKey` |
| `FE:13F ExCheck_SpeedHack` |
| `FE:140 ExBR_NewIConCashBtnWnd` |
| `FE:141 ExEventCampaignInfo` |
| `FE:142 ExUnReadMailCount` |
| `FE:143 ExPledgeCount` |
| `FE:144 ExAdenaInvenCount` |
| `FE:145 ExPledgeRecruitInfo` |
| `FE:146 ExPledgeRecruitApplyInfo` |
| `FE:147 ExPledgeRecruitBoardSearch` |
| `FE:148 ExPledgeRecruitBoardDetail` |
| `FE:149 ExPledgeWaitingListApplied` |
| `FE:14A ExPledgeWaitingList` |
| `FE:14B ExPledgeWaitingUser` |
| `FE:14C ExPledgeDraftListSearch` |
| `FE:14D ExPledgeWaitingListAlarm` |
| `FE:14E ExValidateActiveCharacter` |
| `FE:14F ExCloseCommissionRegister` |
| `FE:150 ExTeleportToLocationActivate` |
| `FE:151 ExNotifyWebPetitionReplyAlarm` |
| `FE:152 ExEventShowXMasWishCard` |
| `FE:153 ExInvitation_Event_UI_Setting` |
| `FE:154 ExInvitation_Event_Ink_Energy` |
| `FE:155 ExCheckAbusing` |
| `FE:156 ExGMVitalityEffectInfo` |
| `FE:157 ExPathToAwakeningAlarm` |
| `FE:158 ExPutEnchantScrollItemResult` |
| `FE:159 ExRemoveEnchantSupportItemResult` |
| `FE:15A ExShowCardRewardList` |
| `FE:15B ExGmViewCharacterInfo` |
| `FE:15C ExUserInfo` |
| `FE:15D ExUserInfoEquipSlot` |
| `FE:15E ExUserInfoCubic` |
| `FE:15F ExUserInfoAbnormalVisualEffect` |
| `FE:160 ExUserInfoFishing` |
| `FE:161 ExPartySpelledInfoUpdate` |
| `FE:162 ExDivideAdenaStart` |
| `FE:163 ExDivideAdenaCancel` |
| `FE:164 ExDivideAdenaDone` |
| `FE:165 ExPetInfo` |
| `FE:166 ExSummonInfo` |
| `FE:167 ExNpcInfo` |
| `FE:168 ExAcquireAPSkillList` |
| `FE:169 ExStartLuckyGame` |
| `FE:16A ExBettingLuckyGameResult` |
| `FE:16B ExTrainingZone_Admission` |
| `FE:16C ExTrainingZone_Leaving` |
| `FE:16D ExPeriodicHenna` |
| `FE:16E ExNpcInfoState` |
| `FE:16F ExNpcInfoAbnormalVisualEffect` |
| `FE:170 ExShowAPListWnd` |
| `FE:171 ExUserInfoInvenWeight` |
| `FE:172 ExCloseAPListWnd` |
| `FE:173 ExEnchantOneOK` |
| `FE:174 ExEnchantOneFail` |
| `FE:175 ExEnchantOneRemoveOK` |
| `FE:176 ExEnchantOneRemoveFail` |
| `FE:177 ExEnchantTwoOK` |
| `FE:178 ExEnchantTwoFail` |
