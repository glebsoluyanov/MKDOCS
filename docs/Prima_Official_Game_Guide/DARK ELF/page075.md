...
# 73 INTRODUCTION
## DARK ELF
![1.jpg](../../assets/images/75/1.jpg){width=300 align=right}
...
``` mermaid
flowchart TB
    A[DARK FIGHTER] --> |20lvl|B
    A[DARK FIGHTER] --> |20lvl|C

    B[PALUS KNIGHT] --> |40lvl|B1
    B[PALUS KNIGHT] --> |40lvl|B2
...
``` mermaid
flowchart TB
    A[DARK MYSTIC] --> |20lvl|B
    A[DARK MYSTIC] --> |20lvl|C

    B[DARK WIZARD] --> |40lvl|B1
    B[DARK WIZARD] --> |40lvl|B2

    B1[SPELLHOWER]
    B2[PHANTOM SUMMONER]

    C[SHILLEN ORACLE] --> |40lvl|C1
