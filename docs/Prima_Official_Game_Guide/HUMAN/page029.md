...
![1.jpg](../../assets/images/29/1_ai.png){width=350 align=right}
...
``` mermaid
flowchart TB
    A[HUMAN MYSTIC] --> |20lvl|B
    A[HUMAN MYSTIC] --> |20lvl|C

    B[Human Wizard] --> |40lvl|B1
    B[Human Wizard] --> |40lvl|B2
    B[Human Wizard] --> |40lvl|B3
...
``` mermaid
flowchart TD
    A[HUMAN FIGHTER] --> |20lvl|B
    A[HUMAN FIGHTER] --> |20lvl|C
    A[HUMAN FIGHTER] --> |20lvl|D
    ...
    C[Human Knight] --> |40lvl|C1
    C[Human Knight] --> |40lvl|C2
