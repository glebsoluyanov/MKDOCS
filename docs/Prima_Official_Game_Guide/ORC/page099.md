...
Don’t even think about soloing here until you’re in your late teens! With a powerful group, you may be able to successfully hunt the northern chambers by Level 15 or so.

The cave has a river that runs through it, just past the main chamber. If you jump into it, you’d better head north — going the other way will dump you into a chamber with about a dozen heavy hitters, several of which are aggressive. Also in the Cave of Trials, you’ll find Slave Skeletons, who have an ever-so-slight chance of dropping Foxnail. Baranka Escorts will occasionally drop bone armor. Scarlet Salamander Elder has a slim chance of giving you Cestus.

**Nearest Town.** Orc Village  
**Appropriate Levels.** 10–20  
...
|------------------------|-----|------------|-----------|--------------------------|--------------|------|-----------------------|
| Orc’s Tutorial         | 2   | Orc        | Hunt/Collect | Fire Priest Tokum or Shela | Starting Area | N    | Elmore Map            |
| Long Live the Paagrio Lord | 3   | Orc        | Delivery  | Centaurian Nakusain      | Orc Village  | Y    | Necklace of Courage/Valor* |
| Proof of Valor         | 4   | Orc        | Hunt/Collect | Praetorian Rukain        | Orc Village  | N    | Necklace of Courage/Valor* |
| Wrath of Ancestors     | 5   | Orc        | Hunt/Collect | Seer Livina              | Orc Village  | Y    | 1500a                 |
| Invaders of the Holy Land | 6  | Orc        | Hunt/Collect | Atuba Chief Varkees       | Orc Village  | Y    | x 5a, x 50a           |
| Skirmish with Werewolves | 9  | Orc        | Hunt/Collect | Prefect Brukurse (pre-req = *) | Orc Village  | Y    | 1200a (+600a)         |
| Dark Winged Spies      | 11  | Orc        | Hunt/Collect | Neruga Chief Tantus       | Orc Village  | Y    | 3500a                 |
| Merciless Punishment   | 12  | Orc        | Hunt/Collect | Urutu Chief Hatos         | Orc Village  | N    | Butcher’s Sword       |
