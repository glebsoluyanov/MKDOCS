...
- Умения:
    - ![ct25p1](../../assets/images/chronicles/ct2_5p1/icon/Опыт_Коллекционера.jpg) **Опыт Коллекционера** - исправлено описание, чтобы соответствовало действию умения
    - ![ct25p1](../../assets/images/chronicles/ct2_5p1/icon/Божественная_Защита.jpg) **Божественная Защита** - исправлено описание улучшения умения на Время
    - ![ct25p1](../../assets/images/chronicles/ct2_5p1/icon/Смертельный_Выстрел.jpg) **Смертельный Выстрел** - исправлена мощность умения в описании
    ...
    - ![ct25p1](../../assets/images/chronicles/ct2_5p1/icon/Кража_Божественности.jpg) **Кража Божественности** - добавлена зависимость похождения от разницы в уровнях персонажей
    - ![ct25p1](../../assets/images/chronicles/ct2_5p1/icon/Безумие.jpg) **Безумие** - время повторного применения изменено с 10 мин. до 5 мин. (данное изменение уже добавлено в патчнот выше)
- Квесты:
...
- Предметы:
    - В список товаров всех торговцев за исключением торговцев Долине Драконов добавлены ![ct25p1](../../assets/images/chronicles/ct2_5p1/icon/Негасимый_Порох.jpg) Негасимый Порох и ![ct25p1](../../assets/images/chronicles/ct2_5p1/icon/Эликсир_Ментальной_Силы_(Ранг_D).jpg) Эликсир Ментальной Силы (Ранг D)
- Умения:
...
- Умения:
    - ![ct25p1](../../assets/images/chronicles/ct2_5p1/icon/Смертоносный_Удар.jpg) **Смертоносный Удар** и ![ct25p1](../../assets/images/chronicles/ct2_5p1/icon/Смертельный_Выстрел.jpg) **Смертельный Выстрел** исправлены проблемы с улучшением умений
...
- Квесты:
    ...
    - Исправлена работа предмета ![ct25p1](../../assets/images/chronicles/ct2_5p1/icon/Сейф_Клятвы.jpg) Сейф Клятвы
